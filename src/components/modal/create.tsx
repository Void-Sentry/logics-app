...
export const ModalCreate = memo((props: { isActive: boolean, onActive: Dispatch<SetStateAction<boolean>> }) => {
    return (
        <Transition.Root show={props.isActive} as={Fragment}>
            <Dialog onClose={props.onActive} as="div" className="relative z-10">
                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="dark:bg-navy-800 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button
                                        ...
                                        onClick={() => props.onActive(!props.isActive)}
                                    >
                                        Excluir
                                    </button>
                                    <button
